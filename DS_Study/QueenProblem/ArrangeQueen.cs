...
namespace QueenProblem
{
    class ArrangeQueen
    {
        ...
        public ArrangeQueen(int[,] board)
        {
            chessBoard = board;
            Arrange(0, board.GetUpperBound(1));
        }

        private bool Arrange(int row, int ArrayBound)
        {
            if (row > ArrayBound)
                return true;
        ...
        private bool IsValidLocation(int iRowIndex, int iColumnIndex, int ArrayBound)
        {
